...
configurations.all {
    ...
    resolutionStrategy {
        ...
        force("org.junit.platform:junit-platform-suite:6.0.3")
        force("org.junit.platform:junit-platform-suite-api:6.0.3")
        force("org.junit.platform:junit-platform-suite-engine:6.0.3")
